...
from src.redis_utils.get_data import  get_spot_back_prices, get_latest_quantities, get_historical_quantities, get_spot_quantity_values
...
def current_holdings():
    ...
    try:
        result = jsonify(get_latest_quantities(market)), 200
